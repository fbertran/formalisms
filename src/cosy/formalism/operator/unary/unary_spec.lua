...
describe ("Formalism unary", function ()

  it ("can be loaded", function ()
    local _ = Layer.require "cosy/formalism/operator/unary"
  end)

  describe ("with number of operands", function ()

    it ("use good number of operands (1 operand)", function ()
      local unary_operator  = Layer.require "cosy/formalism/operator/unary"
    ...
    it ("forbids more than 1 operand", function ()
      local unary_operator  = Layer.require "cosy/formalism/operator/unary"
      local number         = Layer.require "cosy/formalism/literal.number"
