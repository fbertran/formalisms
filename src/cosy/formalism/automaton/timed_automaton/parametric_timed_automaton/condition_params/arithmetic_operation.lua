...
return function (Layer, arithmetic_operation)
  ...
  arithmetic_operation [refines] = {
    ...
    Layer.require "cosy/formalism/automaton/timed_automaton/parametric_timed_automaton/condition_params/operands_relational_type",
    Layer.require "cosy/formalism/automaton/timed_automaton/parametric_timed_automaton/condition_params/operands_arithmetic_type",
  }
