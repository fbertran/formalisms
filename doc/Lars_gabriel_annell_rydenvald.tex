...
\noindent Si on veut avoir l'associativité gauche, ce résultat est évidemment faux. Pour avoir un output correct, il nous suffit d'opérer de manière récursive (la gestion d'erreurs ou d'opérateurs différents est omise ici), on a donc
\begin{minted}{lua}
