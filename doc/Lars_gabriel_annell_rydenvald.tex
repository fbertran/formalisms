...
qui est une plateforme de modélisation formelle. Elle permet aux utilisateurs de créer des modèles formels modulaires, ainsi que d'effectuer des vérifications de propriétés sur ces modèles. \\
